...
{
    [ADEumInstrumentation startTimerWithName:@"startDidFinishLaunchingWithOptions"];
    ...
    [self initInstrumentation];
    [self deleteSQLLite];
    _isConnected = [self isReachable];

    [ADEumInstrumentation initWithKey:_appKey collectorUrl:_collectorUrl enableLogging:TRUE];
...
{
        [ADEumInstrumentation startTimerWithName:@"loadDefaults"];
    ...
    [ADEumInstrumentation stopTimerWithName:@"loadDefaults"];
}
